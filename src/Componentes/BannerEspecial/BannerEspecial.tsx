export function BannerEspecial() {
  ...
  return (
    ...
    <span className="inline-block text-[14px] animate-moveRightToLeft w-full box-border lg:tracking-[.3rem]">01-05 DIA DO PASTEL DA MISSÃO! CLIQUE E RESERVE O SEU  <i className="bi bi-whatsapp text-black"></i></span>
  </div>
  );
}
